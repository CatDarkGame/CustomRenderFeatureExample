...
public class BoxblurTwoPassRenderPass : ScriptableRenderPass
{
    private static readonly string PASS_TAG = "BoxblurTwoPassRenderPass";
    ...
    public BoxblurTwoPassRenderPass(RenderPassEvent renderPassEvent, Material material)
    {
